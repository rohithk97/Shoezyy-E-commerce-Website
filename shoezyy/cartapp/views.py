...
def placeOrder(request):
   if request.method =='POST':
         ...
         newPayment.save()
         newOrder.payment = newPayment
         order_number = 'Shoezyy'+ order_number
...
def orderComplete(request,ordernumber) :
    ...
    return render(request,'cart/order_complete.html',locals())
...
def cancelOrder(request, id):
    ...
    client = razorpay.Client(auth=(shoezyy.settings.API_KEY, shoezyy.settings.RAZORPAY_SECRET_KEY))
